...
class EntryReportService
{
    ...
    private function transformReport(AttendanceSheet $report, ?Collection $users = null, ?Collection $people = null): array
    {
        ...
        return [
            ...
            'action_label' => $report->action === 'entry' ? __('backend_messages.log') : __('backend_messages.exit'),
            'action_badge_class' => $report->action === 'entry' ? 'bg-label-primary' : 'bg-label-info',
            'status' => $report->status,
            'status_label' => __('backend_messages.successful'),
            'status_badge_class' => 'bg-label-success',
            'reason' => $report->reason,
            'reason_label' => __('backend_messages.successful'),
    ...
    private function options(bool $canSelectClient): array
    {
        return [
            'statuses' => [
                ['value' => 'success', 'label' => __('backend_messages.successful')],
                ['value' => 'denied', 'label' => __('backend_messages.rejected')],
            ],
            'actions' => [
                ['value' => 'entry', 'label' => __('backend_messages.log')],
                ['value' => 'exit', 'label' => __('backend_messages.exit')],
            ...
            'reasons' => [
                ['value' => 'success', 'label' => __('backend_messages.successful')],
                ['value' => 'invalid_mac', 'label' => __('backend_messages.invalid_device_mac')],
                ['value' => 'invalid_entry_code', 'label' => __('backend_messages.invalid_entry_code')],
                ['value' => 'subscription_expired', 'label' => __('backend_messages.membership_expired')],
                ['value' => 'no_active_subscription', 'label' => __('backend_messages.no_active_membership')],
                ['value' => 'owner_not_found', 'label' => __('backend_messages.user_customer_not_found')],
                ['value' => 'client_mismatch', 'label' => __('backend_messages.invalid_branch')],
            ],
