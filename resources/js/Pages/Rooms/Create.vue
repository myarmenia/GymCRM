...
const submit = () => {
    ...
    form.post(route("rooms.store", { locale: currentLocale }));
};
...
console.log("Room Types:", roomTypesList.value);
console.log("Room Amenities:", roomAmenitiesList.value);
</script>
        ...
        <div class="room-form-page">
            <div class="page-header">
                <div>
                    ...
                    <p class="page-subtitle">Add a new gym room</p>
                </div>
...
<style src="/resources/css/rooms/create.css"></style>
