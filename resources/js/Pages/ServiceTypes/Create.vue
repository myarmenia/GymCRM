...
const submit = () => {
    form.post(route("service-types.store", { locale: currentLocale }));
};
</script>
    ...
    <AppLayout>
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Create Service Type</h5>

                <Link
                    :href="route('service-types.index', { locale: currentLocale })"
                ...
                <form @submit.prevent="submit">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            />
                            <div
                                v-if="form.errors['translations.en.description']"
                                class="text-danger small mt-1"
                            >
                        ...
                        <div class="col-md-6">
                            ...
                            />
                            <div
                                v-if="form.errors['translations.ru.description']"
                                class="text-danger small mt-1"
                            >
                        ...
                        <div class="col-md-6">
                            ...
                            />
                            <div
                                v-if="form.errors['translations.hy.description']"
                                class="text-danger small mt-1"
                            >
