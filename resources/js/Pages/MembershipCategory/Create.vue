...
props.locales.forEach(locale => {
    form.translations[locale] = { name: '', description: '' };
});

const submit = () => {
    form.post(route('membership-category.store', { locale: currentLocale }));
};
</script>

<template>
    <Head title="Ավելացնել անդամակցության կատեգորիա" />
    <Index>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                Անդամակցության կատեգորիաներ / Ավելացնել
            </h2>
        </template>
        <div class="card mb-6">
            <h5 class="card-header">Նոր կատեգորիա</h5>
            <form @submit.prevent="submit" class="card-body">
                <div class="row g-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <TextInput v-model="form.slug" placeholder="unique-slug" />
                ...
                <div class="pt-6 d-flex justify-content-end gap-2">
                    <PrimaryButton :disabled="form.processing">Պահպանել</PrimaryButton>
