...
const routeWithFilters = query => {
    router.get(
        route('reports.salesperson-commissions', { locale: currentLocale.value }),
...
const exportHref = computed(() => route('reports.salesperson-commissions.export', {
...
const filterValues = computed(() => ({
    salesperson_id: filters.value.salesperson_id ?? '',
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td>{{ commission.membership_sale }}</td>
