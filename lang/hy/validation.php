...
return [
    ...
    */
    ...
    'not-in' => 'Ընտրված :attribute-ն անվավեր է:',
    ...
    'password' => [
        ...
        'uncompromised' => 'Տվյալ :attribute-ը հայտնվել է տվյալների արտահոսքի մեջ: Խնդրում ենք ընտրել այլ :attribute :',
    ],
    ...
    'required' => ':attribute դաշտը պարտադիր է:',  // <-- ВАША СТРОКА
    ...
    'required-without-all' => ':attribute դաշտը պարտադիր է, երբ :values -ներից ոչ մեկը չկա:',
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Validation Attributes (читаемые имена полей)
    |--------------------------------------------------------------------------
    */
    'attributes' => [
        'name' => 'Անուն',
        ...
        'percent' => 'Տոկոս',
        'tin' => 'ՀՎՀՀ',
        'membership_category_id' => 'անդամության կատեգորիա',  // <-- ЭТО ВАШЕ ОТСУТСТВУЮЩЕЕ ПОЛЕ!
    ],

    // Ваши дополнительные строки (их оставьте в конце, вне основных секций)
